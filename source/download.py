...
if __name__ == '__main__':
    downloadDavisDataset(DavisDatasetUrls["train480p"],os.path.abspath(os.path.join(os.path.dirname(__file__), "../datasets/Davis/train480p")))
    downloadDavisDataset(DavisDatasetUrls["test480p"],os.path.abspath(os.path.join(os.path.dirname(__file__), "../datasets/Davis/test480p")))
